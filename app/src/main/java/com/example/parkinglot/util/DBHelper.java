...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + Constants.DataBaseTableName.HISTORY + "(_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
        ...
        db.execSQL("CREATE TABLE " + Constants.DataBaseTableName.BOOKMARK + "(parkingLotNo TEXT PRIMARY KEY, " +
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        // 테이블 삭제
        db.execSQL("DROP TABLE IF EXISTS "  + Constants.DataBaseTableName.HISTORY);
        db.execSQL("DROP TABLE IF EXISTS "  + Constants.DataBaseTableName.BOOKMARK);
