...
import com.example.parkinglot.adapter.BookmarkAdapter;
import com.example.parkinglot.entity.ParkingLot;
import com.example.parkinglot.listener.OnItemClickListener;
...
public class BookmarkActivity extends AppCompatActivity {
    ...
    private ArrayList<ParkingLot> getItems() {
        ...
        String sql = "SELECT parkingLotNo, parkingLotName, latitude, longitude FROM " +
                Constants.DataBaseTableName.BOOKMARK + " ORDER BY parkingLotName";
    ...
    private void deleteBookmark(String parkingLotNo, int position) {
        ...
        try {
            // 즐겨찾기 삭제
            String sql = "DELETE FROM " + Constants.DataBaseTableName.BOOKMARK + " WHERE parkingLotNo = ?";
